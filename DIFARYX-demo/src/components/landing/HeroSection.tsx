      ...
      <div className="mx-auto max-w-[1200px] px-6">
        <div className="grid grid-cols-1 items-center gap-14 lg:grid-cols-[52%_48%]">
          <div className="max-w-[720px]">
            ...
            <p className="mb-4 max-w-[720px] text-[16px] leading-[30px] text-slate-600 lg:text-[18px]">
              DIFARYX executes structured scientific workflows directly from experimental signals, transforming raw data into evidence linked, traceable, and reproducible decisions within a unified system.
            </p>
            <p className="mb-8 max-w-[720px] text-[15px] leading-[28px] text-slate-500">
              Designed for autonomous execution, transparent reasoning, and reproducible scientific workflows.
            </p>
